package com.example.ThirdAssignmentTemplate;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.add_note_activity:
                Intent addActivityIntent = new Intent(getApplicationContext(), com.example.ThirdAssignmentTemplate.AddNoteActivity.class);
                startActivity(addActivityIntent);
                return true;
            case R.id.delete_note_activity:
                Intent addActivityIntent1 = new Intent(getApplicationContext(), com.example.ThirdAssignmentTemplate.DeleteNoteActivity.class);
